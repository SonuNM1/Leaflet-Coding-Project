...
// GeoJSON - used for representing geographical features along with their non-spatial attributes(spatial attribute -> latitude longitude || Non-spatial attributes -> city's population, area, timezone, metadata) . Used to add geoemtric data to maps. Leaflet provides methods to parse GeoJSON data and render it as interactive map features. 
